...
typedef struct fs_queue FSQueue;
...
extern FSQueue *fs_queue; // fila de acesso ao sistema de arquivos
...
extern pthread_mutex_t mutex_fs_queue; // mutex para a fila de acesso ao sistema de arquivos
extern pthread_mutex_t mutex_disk_queue; // mutex para a fila de acesso ao disco
extern bool fs_busy; // se algum processo está acessando o sistema de arquivos ou ele está livre
